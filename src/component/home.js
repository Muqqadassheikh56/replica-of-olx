...
import land_image from '../images/land.webp'
            ...
            <div>
                ...
                <div className="container mt-5">
                    ...
                    <div className="col-6 col-md-4 col-lg-3 mb-4">
                        ...
                        <div className="col-6  col-md-4 col-lg-3 mb-4">
                            <MediaCard homeFunc={this.fullDetails} img={tv_image} price={"Rs: 15,5000"} time={"3 days ago"} location={"Jhang"} title="TV for Sale in Jhang" description={"Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum."} />
                        </div>
                        <div className="col-6  col-md-4 col-lg-3 mb-4">
